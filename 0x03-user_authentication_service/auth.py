#!/usr/bin/env python3
"""
define the Auth class and helper functions for user authentication.
"""
...
class Auth:
    """
    Auth class to handle user authentication, registration,
    ...
    def destroy_session(self, user_id: int) -> None:
        """
        Destroy a user's session by setting the session ID to None.
        Args:
    ...
    def update_password(self, reset_token: str, password: str) -> None:
        ...
        Raises:
        - ValueError if the reset token or password is invalid.
        """
